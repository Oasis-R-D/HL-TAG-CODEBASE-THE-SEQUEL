...
public:
	...
	bool AddOverviewEntityToList(HSPRITE_ sprite, cl_entity_t* ent, double killTime);
...
private:
	...
	HSPRITE_ m_hsprPlayerBlue;
	HSPRITE_ m_hsprPlayerRed;
	HSPRITE_ m_hsprPlayer;
	HSPRITE_ m_hsprCamera;
	HSPRITE_ m_hsprPlayerDead;
	HSPRITE_ m_hsprViewcone;
	HSPRITE_ m_hsprUnkownMap;
	HSPRITE_ m_hsprBeam;
	HSPRITE_ m_hCrosshair;
