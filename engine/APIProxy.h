...
typedef HSPRITE_ (*pfnEngSrc_pfnSPR_Load_t)(const char* szPicName);
typedef int (*pfnEngSrc_pfnSPR_Frames_t)(HSPRITE_ hPic);
typedef int (*pfnEngSrc_pfnSPR_Height_t)(HSPRITE_ hPic, int frame);
typedef int (*pfnEngSrc_pfnSPR_Width_t)(HSPRITE_ hPic, int frame);
typedef void (*pfnEngSrc_pfnSPR_Set_t)(HSPRITE_ hPic, int r, int g, int b);
...
typedef void (*pfnEngSrc_pfnSetCrosshair_t)(HSPRITE_ hspr, Rect rc, int r, int g, int b);
...
typedef const struct model_s* (*pfnEngSrc_GetSpritePointer_t)(HSPRITE_ hSprite);
